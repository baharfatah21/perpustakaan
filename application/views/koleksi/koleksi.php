                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <?php foreach ($list as $item) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="koleksi/detail/<?php echo $item['id_koleksi']; ?>" class="btn btn-info">Detail</a>
                                    <a href="koleksi/edit/<?php echo $item['id_koleksi']; ?>" class="btn btn-warning">Edit</a>
                                    <a onclick="konfirmasi(<?php echo $item['id_koleksi']; ?>)" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
